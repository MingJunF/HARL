...
class SatBenchContinuousImagingFSWModel10(ImagingFSWModel):
    ...
    def action_image(self, action: int) -> None:
        ...
        action_map = {
            ...
            # Two-axis rotations (roll + pitch only)
            5: (+angle_step, +angle_step, 0),
    ...
    def action_nadir_scan(self) -> None:
        ...
        self.simulator.enableTask(self.LocPointTask.name + self.satellite.name)
class SatBenchContinuousImagingFSWModel20(ImagingFSWModel):
    """FSW model for continuous imaging with attitude control."""
...
class UniqueImagerFSWModel10(SteeringFSWModel, SatBenchContinuousImagingFSWModel10):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        super().__init__(*args, **kwargs)
class UniqueImagerFSWModel20(SteeringFSWModel, SatBenchContinuousImagingFSWModel20):
    """Convenience type for ImagingFSWModel with MRP steering."""
